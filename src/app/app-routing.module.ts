...
const routes: Routes = [
  ...
  // {path:"home", component: HomeComponent, title: 'Strona główna', canActivate: [auth, confirmProfile]},
  ...
  {path:'editProfile/:id', component: EditProfileComponent, title:"Edycja profilu", canActivate: [auth]},
  {path:'usersList', component: UsersListComponent, title:"Lista użytkowników", canActivate: [auth]},
  {path:'createSchedule', component: CreateScheduleComponent, title:"Stwórz grafik", canActivate: [auth, workerRole]},
  {path:'schedules', component: DoctorScheduleComponent, title:"Grafik", canActivate: [auth, workerRole]},
  ...
  {path:'scheduleDoctor', component: ScheduleDoctorComponent, title:"Grafik", canActivate: [auth, doctorRole]},
  {path:'reservationDetails/:id/:date', component: ReservationDoctorModalComponent, title:"Rezerwacje"},



  {path:'createUser', component: CreateUserComponent, title:"Dodaj nowego użytkownika", canActivate: [auth, moderatorRole]},
